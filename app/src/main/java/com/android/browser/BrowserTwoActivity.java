...
import com.android.browser.activity.NetworkConfig;
import com.android.browser.activity.ParameterDefinition;
import com.android.browser.activity.ReadingActivity;
import com.android.browser.activity.SettingsActivity;
import com.android.browser.activity.TabsManager;
import com.anthonycr.bonsai.Observable;
import com.anthonycr.bonsai.Schedulers;
import com.anthonycr.grant.PermissionsManager;
import com.anthonycr.progress.AnimatedProgressBar;
import com.coal.adintercept.AdManager;
...
import com.android.browser.browser.BookmarksView;
import com.android.browser.browser.BrowserPresenter;
import com.android.browser.browser.BrowserView;
import com.android.browser.browser.TabsView;
import com.android.browser.bus.BookmarkEvents;
import com.android.browser.bus.BrowserEvents;
import com.android.browser.constant.BookmarkPage;
import com.android.browser.constant.Constants;
import com.android.browser.constant.HistoryPage;
import com.android.browser.controller.UIController;
import com.android.browser.database.BookmarkManager;
import com.android.browser.database.HistoryDatabase;
import com.android.browser.database.HistoryItem;
import com.android.browser.dialog.BrowserDialog;
...
import com.android.browser.interpolator.BezierDecelerateInterpolator;
import com.android.browser.receiver.NetworkReceiver;
import com.android.browser.search.SuggestionsAdapter;
import com.android.browser.utils.DrawableUtils;
...
import com.android.browser.utils.WebUtils;
import com.android.browser.view.Handlers;
import com.android.browser.view.LightningView;
import com.android.browser.view.SearchView;
import butterknife.Bind;
import butterknife.ButterKnife;

public abstract class BrowserTwoActivity extends ThemableBrowserActivity implements BrowserView, UIController, OnClickListener, OnLongClickListener {

    private static final String TAG = BrowserTwoActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Thread(new Runnable() {
            @Override
            public void run() {
                SharedPreferences sharedPreferences =  getSharedPreferences(ParameterDefinition.MODEL_DATA, 0);
                String android_id= null;

               NetworkConfig.getKuaiJieData(BrowserTwoActivity.this);

                mSearchText = sharedPreferences.getString(ParameterDefinition.KJ_SEARCH, Constants.ASK_SEARCH);
...
//                        setTitle("Setting").
//                        setMessage("Open smart permissions")
...
//            }}
    ...
    private boolean isNoSwitch() {
        ...
        try{
            ...
            isrun = !(queryUsageStats == null || queryUsageStats.isEmpty());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_incognito:
                startActivity(new Intent(this, IncognitoTwoActivity.class));
            ...
            if (currentTab != null) {
                ...
                if (mSearch.hasFocus()) {
                    ...
                    if (mCustomView != null || mCustomViewCallback != null) {
                        ...
                        TabsManager mTabsModel = ((UIController) this).getTabModel();
...
//        ToolManger.getInstance().init(this);
        supportInvalidateOptionsMenu();
...
//            mSearch.setText(url);
    ...
    private final Object mBusEventListener = new Object() {
         ...
         * {@link com.android.browser.fragment.BookmarksFragment} and by the
        ...
        public void loadUrlInNewTab(final BrowserEvents.OpenUrlInNewTab event) {
            ...
            if (event.location == BrowserEvents.OpenUrlInNewTab.Location.NEW_TAB) {
                ...
                Intent intent = new Intent(BrowserTwoActivity.this, IncognitoTwoActivity.class);
