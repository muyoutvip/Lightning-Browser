...
import com.android.browser.utils.IntentUtils;
import com.android.browser.utils.Preconditions;
...
//            }
    ...
    private boolean isMailOrIntent(@NonNull String url, @NonNull WebView view) {
        Log.d("LightningWeb","isMailOrIntent----"+url);
        if (url.startsWith("mailto:")) {
            ...
            Log.d("LightningWeb","isMailOrIntent----"+url+"---3333-");
            Intent intent;
            try {
